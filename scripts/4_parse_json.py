...
# --- CONFIG ---
part_number = input("Enter catalog part number (e.g. 1, 2, 3...): ").strip()
INPUT_JSON = f"json_results/output_{part_number}.json"
OUTPUT_CSV = f"parsed_results/courses_part_{part_number}.csv"
